...
This file pins `2.0.0` and binds to localhost. For a network installation, configure an authenticated proxy or trusted-network port mapping. The container currently supports linux/amd64.
